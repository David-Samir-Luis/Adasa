...
import { IcategoryIcon } from '../icategory-icon';
...
export class MainPage {
  ...
  getRecent(){
    return this.data.posts.slice().sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()).slice(0,3);
